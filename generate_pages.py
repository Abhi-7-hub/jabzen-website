...
<head>
  ...
  <link rel="stylesheet" href="styles.min.css?v=18">
</head>
  ...
  <header class="site-header" id="site-header">
    <nav class="nav" aria-label="Main navigation">
      ...
      <div class="nav-actions">
        ...
        <a href="blog#blog-auth-section" id="header-login-btn" class="btn btn-outline header-login-btn" style="margin-right: 0.5rem; display: none;">Sign In</a>
...
HTML_FOOTER = """
  ...
  <script src="main.min.js?v=18" defer></script>
</body>
</html>
"""
    ...
    <section class="section soft" id="contact" style="padding: 70px 0; background: var(--soft);">
      <div class="container split" style="display: grid; gap: 3rem; grid-template-columns: 1.15fr 0.85fr;">
        ...
        <form class="form-wrap" data-lead-form style="background: var(--card-bg); border-color: var(--line); margin: 0;">
          ...
          <p class="success-message" data-success-message style="color: var(--accent); font-weight: 700; margin-top: 1rem; text-align: center; display: none;">Thanks! Booking consultation call on WhatsApp...</p>
        </form>
      </div>
    </section>
  </main>
        ...
        <div id="guest-auth-container" style="display: block;">
          <div style="display: flex; flex-direction: column; gap: 2rem;">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.75rem; border-bottom: 1px solid var(--border-color); padding-bottom: 1.5rem;">
              ...
              <button id="facebook-login-btn" class="btn btn-secondary" style="padding: 0.75rem 1.5rem; font-weight: 700; display: inline-flex; align-items: center; gap: 8px; border-radius: 30px; justify-content: center; background: #1877f2; color: #ffffff; border-color: #1877f2;"><i class="fa-brands fa-facebook"></i> Sign In with Facebook</button>
